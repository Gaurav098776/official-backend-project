...
import { REFERRAL_HISTORY_REPOSITORY } from 'src/constants/entities';
import { RepositoryManager } from './repository.manager';
import { k500Error } from 'src/constants/misc';
import { ReferralHistoryEntity } from 'src/entities/referralHistory.entity';

@Injectable()
export class ReferralHistoryRepository {
  constructor(
    @Inject(REFERRAL_HISTORY_REPOSITORY)
    private readonly repository: typeof ReferralHistoryEntity,
