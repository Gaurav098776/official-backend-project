...
import { RBI_GUIDELINE_REPOSITORY } from 'src/constants/entities';

@Injectable()
export class RBIGuidelineRepository {
  constructor(
    @Inject(RBI_GUIDELINE_REPOSITORY)
    private readonly repository: typeof RBIGuidelineEntity,
