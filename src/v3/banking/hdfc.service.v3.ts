...
@Injectable()
export class HDFCBankingService {
  constructor(
    private readonly dateService: DateService,
    private readonly commonNetbankingService: commonNetBankingService,
  ) {}
            ...
            triggers: [
              ...
              `console.log("METRICS->02");
                      ...
                      const invalidPassword = () => {
                          ...
                          if (window.frames.main_part?.document) return console.log("startProcessing");
                          setTimeout(() => {
                              console.log("stopProcessing");
                          }, 700);
                      };
                      ...
                      var loadedScreen = setInterval(() => {
                        if(window.frames.main_part?.document.getElementsByClassName('SavingTotalSummary')) {
                          try{
                            main();
